...
class TestFCC:
    def test_getRepayment_fcc(self):
        ...
        prod_url = "https://madhurfinance.com"
        endpoint = "/admin-prod/admin/transaction/allRepaidLoans"
        ...
        allRepaidLoanAPI = requests.get(f"{prod_url}{endpoint}", params=params)
        allRepaidLoanAPIData = allRepaidLoanAPI.json()["data"]['rows']



        prep_lid = []
        for d in allRepaidLoanAPIData:
        ...
        prep_lid_3 = []
        for n, d in enumerate(allRepaidLoanAPIData):
