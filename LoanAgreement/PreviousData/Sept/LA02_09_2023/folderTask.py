    ...
    def test_keyFactStatement(self, setup_teardown):
        ...
        try:
            if loanInterestPerDay in firstPage:
                ...
                print(f"Exception :: 'loanInterestPerDay' :'{loanInterestPerDay}' is not matched with LOAN DETAILS first Page of pdf ")
            ...
            try:
                if loanInterestPerDay2 in firstPage:
                    print(
                        f" *** 'loanInterestPerDay2' :'{loanInterestPerDay2}' is matched with LOAN DETAILS first Page of pdf *** ")
                else:
                    print(
                        f"Exception :: 'loanInterestPerDay2' :'{loanInterestPerDay2}' is not matched with LOAN DETAILS first Page of pdf ")

                assert loanInterestPerDay2 in firstPage, "loanInterestPerDay is matched with LOAN DETAILS first Page of pdf"

            except:
                if loanInterestPerDay3 in firstPage:
                    print(
                        f" *** 'loanInterestPerDay3' :'{loanInterestPerDay3}' is matched with LOAN DETAILS first Page of pdf *** ")
                else:
                    print(
                        f"Error :: 'loanInterestPerDay3' :'{loanInterestPerDay3}' is not matched with LOAN DETAILS first Page of pdf ")

                assert loanInterestPerDay3 in firstPage, "loanInterestPerDay3 is matched with LOAN DETAILS first Page of pdf"
        ...
        try:
            if processCharge in firstPage:
                ...
                print(f"Exception :: 'processCharge' :'{processCharge}' is not matched with CHARGES Section first Page of pdf ")
            ...
            if processChargeRs in firstPage:
                print(f" *** 'processChargeRs' :'{processChargeRs}' is matched and with CHARGES Section first Page of pdf *** ")
            else:
                print(f"Error :: 'processChargeRs' :'{processChargeRs}' is not matched with CHARGES Section first Page of pdf ")

            assert processChargeRs in firstPage, "processChargeRs is matched with CHARGES Section first Page of pdf"
        ...
        try:
            if latePaymentChargePerAnnualString in firstPage:
                ...
                print(f"Exception :: 'latePaymentChargePerAnnualString' :'{latePaymentChargePerAnnualString}' is not matched with CHARGES Section first Page of pdf ")
            ...
            if latePaymentChargePerAnnualString2 in firstPage:
                print(
                    f" *** 'latePaymentChargePerAnnualString2' :'{latePaymentChargePerAnnualString2}' is matched with CHARGES Section first Page of pdf *** ")
            else:
                print(
                    f"Error :: 'latePaymentChargePerAnnualString2' :'{latePaymentChargePerAnnualString2}' is not matched with CHARGES Section first Page of pdf ")

            assert latePaymentChargePerAnnualString2 in firstPage, "is matched with CHARGES Section first Page of pdf"
        ...
        try:
            try:
                ...
                if disbursement in thirdPage:
                    print(
                        f" *** 'disbursement' :'{disbursement}' is matched with LETTER OF SANCTION TO THE BORROWER Section third page of pdf *** ")
                else:
                    print(
                        f"Exception :: 'disbursement' :'{disbursement}' is not matched with LETTER OF SANCTION TO THE BORROWER Section third page of pdf ")
            ...
            try:
                ...
                if disbursement in thirdPage:
                    ...
                    print(
                        f"Error :: 'disbursement' :'{disbursement}' is not matched with LETTER OF SANCTION TO THE BORROWER Section third page of pdf ")
        ...
        try:
            ...
            if penalInterestPerAnnum in fourthPage:
                ...
                print(f"Exception :: 'penalInterestPerAnnum' :'{penalInterestPerAnnum}' is not matched with SECURITY DOCUMENTS fourth Page of pdf ")
            ...
            if penalInterestPerAnnum2 in fourthPage:
                print(
                    f" *** 'penalInterestPerAnnum2' :'{penalInterestPerAnnum2}' is matched with SECURITY DOCUMENTS fourth Page of pdf *** ")
            else:
                print(
                    f"Error :: 'penalInterestPerAnnum2' :'{penalInterestPerAnnum2}' is not matched with SECURITY DOCUMENTS fourth Page of pdf ")

            assert penalInterestPerAnnum2 in fourthPage, "penalInterestPerAnnum2 is matched with SECURITY DOCUMENTS fourth Page of pdf"
        ...
        try:
            if loanInterestPerDay in sixthPage:
                ...
                print(f"Exception :: 'loanInterestPerDay' :'{loanInterestPerDay}' is not matched with LOAN AGREEMENT sixth Page of pdf ")
            ...
            try:
                if loanInterestPerDay2 in sixthPage:
                    print(
                        f" *** 'loanInterestPerDay2' :'{loanInterestPerDay2}' is matched with LOAN AGREEMENT sixth Page of pdf *** ")
                else:
                    print(
                        f"Exception :: 'loanInterestPerDay2' :'{loanInterestPerDay2}' is not matched with LOAN AGREEMENT sixth Page of pdf ")

                assert loanInterestPerDay2 in sixthPage, "loanInterestPerDay is matched with LOAN AGREEMENT sixth Page of pdf"

            except:

                if loanInterestPerDay3 in sixthPage:
                    print(
                        f" *** 'loanInterestPerDay3' :'{loanInterestPerDay3}' is matched with LOAN AGREEMENT sixth Page of pdf *** ")
                else:
                    print(
                        f"Error :: 'loanInterestPerDay3' :'{loanInterestPerDay3}' is not matched with LOAN AGREEMENT sixth Page of pdf ")

                assert loanInterestPerDay3 in sixthPage, "loanInterestPerDay3 is matched with LOAN AGREEMENT sixth Page of pdf"
        ...
        try:
            if latePaymentChargePerAnnualString in sixthPage:
                ...
                print(f"Exception :: 'latePaymentChargePerAnnualString' :'{latePaymentChargePerAnnualString}' is not matched with LOAN AGREEMENT sixth Page of pdf ")
            ...
            if latePaymentChargePerAnnualString2 in sixthPage:
                print(
                    f" *** 'latePaymentChargePerAnnualString2' :'{latePaymentChargePerAnnualString2}' is matched with LOAN AGREEMENT sixth Page of pdf *** ")
            else:
                print(
                    f"Error :: 'latePaymentChargePerAnnualString2' :'{latePaymentChargePerAnnualString2}' is not matched with LOAN AGREEMENT sixth Page of pdf ")

            assert latePaymentChargePerAnnualString2 in sixthPage, "latePaymentChargePerAnnualString2 is matched with LOAN AGREEMENT sixth Page of pdf"
...
#002
if pdf_files:
    second_pdf_filename = pdf_files[1]
    second_pdf_path = os.path.join(folder_path, second_pdf_filename)


    # pdf reader
    reader2 = pypdf.PdfReader(second_pdf_path)        # pdf file location

    firstPage2 = reader2.pages[0].extract_text()
    thirdPage2 = reader2.pages[2].extract_text()
    fourthPage2 = reader2.pages[3].extract_text()
    sixthPage2 = reader2.pages[5].extract_text()
    ninthPage2 = reader2.pages[8].extract_text()

    if 'Loan Id' in firstPage2:
        indexLID = firstPage2.index('Loan Id')
        indexLD = firstPage2.index('LOAN DETAILS')
        text = firstPage2[indexLID + 7:indexLD]
        # print(f"loanID :: {text}")
...
class TestDashRepo:
    ...
    def test_keyFactStatement(self, setup_teardown):
        driver.find_element(By.ID, "mainSearch").send_keys(loanID2)  #
        time.sleep(2)
        driver.find_element(By.XPATH, "(//div[contains(@class,'search-text-master')])").click()  #click user
        time.sleep(2)
        driver.switch_to.window(driver.window_handles[-1])
        ...
        try:
            if profileName in firstPage2:
                print(f" *** 'profileName':'{profileName}' is matched with KEY FACT STATEMENT first Page of pdf *** ")
            else:
                print(f"Exception :: 'profileName':'{profileName}' is not matched with KEY FACT STATEMENT first Page of pdf ")

            assert profileName in firstPage2, "profileName is matched with KEY FACT STATEMENT first Page of pdf"

        except:
            if 'Name of Borrower' in firstPage2:
                index1 = firstPage.index('Name of Borrower')
                index2 = firstPage.index('NBFC NameChinmay Finlease')
                text = firstPage[index1 + 16:index2]
                print(f"Name by pdf module :: {text}")
        ...
        # #loanId
        loanId2 = driver.find_element(By.XPATH,"//tr[contains(@class,'mat-row cdk-row loan-history-row bg-greywhite ng-star-inserted')]//td//a").text
        time.sleep(2)
        if loanId2 in firstPage2:
            print(f" *** 'loanId' :'{loanId2}' is matched with KEY FACT STATEMENT first Page of pdf *** ")
        else:
            print(f"Error :: 'loanId' :'{loanId2}' is not matched with KEY FACT STATEMENT first Page of pdf ")

        assert loanId2 in firstPage2, "loanId is matched with KEY FACT STATEMENT first Page of pdf"
        ...
        try:
            ...
            if LoanApplicationDate in firstPage2:
                print(f" *** 'LoanApplicationDate' :'{LoanApplicationDate}' is matched with KEY FACT STATEMENT first Page of pdf *** ")

            assert LoanApplicationDate in firstPage2, "LoanApplicationDate is matched with KEY FACT STATEMENT first Page of pdf"
            ...
            try:
                ...
                if 'Date of Signing' in firstPage2:
                    index1 = firstPage2.index('Date of Signing')
                    index2 = firstPage2.index('Name of Borrower')
                    text = firstPage2[index1 + 28:index2]
                    print(f"Name by pdf :: {text}")
        ...
        if approvedAmount in firstPage2:
            print(f" *** 'approvedAmount' :'{approvedAmount}' is matched with LOAN DETAILS first Page of pdf *** ")
        else:
            print(f"Error :: 'approvedAmount' :'{approvedAmount}' is not matched with LOAN DETAILS first Page of pdf ")

        assert approvedAmount in firstPage2, "approvedAmount is matched with LOAN DETAILS first Page of pdf"
        ...
        loanInterestPerDay3 = loanIntPerDay.replace(" %", "0%")
        try:
            if loanInterestPerDay in firstPage2:
                print(f" *** 'loanInterestPerDay' :'{loanInterestPerDay}' is matched with LOAN DETAILS first Page of pdf *** ")
            else:
                print(f"Exception :: 'loanInterestPerDay' :'{loanInterestPerDay}' is not matched with LOAN DETAILS first Page of pdf ")

            assert loanInterestPerDay in firstPage2, "loanInterestPerDay is matched with LOAN DETAILS first Page of pdf"
        except:
            try:
                if loanInterestPerDay2 in firstPage2:
                    print(
                        f" *** 'loanInterestPerDay2' :'{loanInterestPerDay2}' is matched with LOAN DETAILS first Page of pdf *** ")
                else:
                    print(
                ...
                assert loanInterestPerDay2 in firstPage2, "loanInterestPerDay is matched with LOAN DETAILS first Page of pdf"

            except:
                if loanInterestPerDay3 in firstPage2:
                    print(
                        f" *** 'loanInterestPerDay3' :'{loanInterestPerDay3}' is matched with LOAN DETAILS first Page of pdf *** ")
                else:
                    print(
                ...
                assert loanInterestPerDay3 in firstPage2, "loanInterestPerDay3 is matched with LOAN DETAILS first Page of pdf"
        ...
        if loanIntPerAnnumStr in firstPage2:
            print(f" *** 'loanIntPerAnnumStr' :'{loanIntPerAnnumStr}%' is matched with LOAN DETAILS first Page of pdf *** ")
        else:
            print(f"Error :: 'loanIntPerAnnumStr' :'{loanIntPerAnnumStr}%'  is not matched with LOAN DETAILS first Page of pdf ")

        assert loanIntPerAnnumStr in firstPage2, "loanIntPerAnnumStr is matched with LOAN DETAILS first Page of pdf"
        ...
        time.sleep(1)
        insurancePremAmount = inPremAmount.replace(" ","")
        if insurancePremAmount in firstPage2:
            print(f" *** 'insurancePremAmount' :'{insurancePremAmount}' is matched with LOAN DETAILS first Page of pdf *** ")
        else:
            print(f"Error :: 'insurancePremAmount' :'{insurancePremAmount}' is not matched with LOAN DETAILS first Page of pdf ")

        assert insurancePremAmount in firstPage2, "insurancePremAmount is matched with LOAN DETAILS first Page of pdf"
        ...
        time.sleep(1)
        loanDurationInDays = loanDurInDays + " Days"
        if loanDurationInDays in firstPage2:
            print(f" *** 'loanDurationInDays' :'{loanDurationInDays}' is matched with LOAN DETAILS first Page of pdf *** ")
        else:
            print(f"Error :: 'loanDurationInDays' :'{loanDurationInDays}' is not matched with LOAN DETAILS first Page of pdf ")

        assert loanDurationInDays in firstPage2, "loanDurationInDays is matched with LOAN DETAILS first Page of pdf"
        ...
        loanDisbursedDate = loanDisbDate.replace("/","-")
        try:
            if loanDisbursedDate in firstPage2:
                print(f" *** 'loanDisbursedDate' :'{loanDisbursedDate}' is matched with LOAN DETAILS first Page of pdf *** ")
            else:
                print(f"Exception :: 'loanDisbursedDate' :'{loanDisbursedDate}' is not matched with LOAN DETAILS first Page of pdf ")

            assert loanDisbursedDate in firstPage2, "loanDisbursedDate is matched with LOAN DETAILS first Page of pdf"
        except:
        ...
        try:
            if loanEndDate in firstPage2:
                print(f" *** 'loanEndDate' :'{loanEndDate}' is matched with LOAN DETAILS first Page of pdf *** ")

            assert loanEndDate in firstPage2, "loanEndDate is matched with LOAN DETAILS first Page of pdf"

        except:
            if loanEndDate2 in firstPage2:
                print(f" *** 'loanEndDate2' :'{loanEndDate2}' is matched with LOAN DETAILS first Page of pdf *** ")
            else:
                print(f"Error :: 'loanEndDate2' :'{loanEndDate2}' is not matched with LOAN DETAILS first Page of pdf ")

            assert loanEndDate2 in firstPage2, "loanEndDate2 is matched with LOAN DETAILS first Page of pdf"
        ...
        processCharge =  processChargeRs[0] + processChargeRs[1] +","+ processChargeRs[2:]
        try:
            if processCharge in firstPage2:
                print(f" *** 'processCharge' :'{processCharge}' is matched and with CHARGES Section first Page of pdf *** ")
            else:
                print(f"Exception :: 'processCharge' :'{processCharge}' is not matched with CHARGES Section first Page of pdf ")

            assert processCharge in firstPage2, "processCharge is matched with CHARGES Section first Page of pdf"

        except:
            if processChargeRs in firstPage2:
                print(f" *** 'processChargeRs' :'{processChargeRs}' is matched and with CHARGES Section first Page of pdf *** ")
            else:
                print(f"Error :: 'processChargeRs' :'{processChargeRs}' is not matched with CHARGES Section first Page of pdf ")

            assert processChargeRs in firstPage2, "processChargeRs is matched with CHARGES Section first Page of pdf"
        ...
        if documentCharges in firstPage2:
            print(f" *** 'documentCharges' :'{documentCharges}' is matched and within CHARGES Section first Page of pdf *** ")
        else:
            print(f"Error :: 'documentCharges' :'{documentCharges}' is not matched and not within CHARGES Section first Page of pdf ")

        assert documentCharges in firstPage2, "is matched and within CHARGES Section first Page of pdf"
        ...
        sgst2 = "₹" + str(round(sgstFloat, 2))
        try:
            if sgst in firstPage2:
                print(f" *** 'sgst' :'{sgst}' is matched with CHARGES Section first Page of pdf *** ")


        except:
            if sgst2 in firstPage2:
                print(f" *** 'sgst2' :'{sgst2}' is matched with CHARGES Section first Page of pdf *** ")
            else:
                print(f"Error :: 'sgst2' :'{sgst2}' is not matched with CHARGES Section first Page of pdf ")

            assert sgst2 in firstPage2, "is matched with CHARGES Section first Page of pdf"
        ...
        cgst2 = "₹" + str(round(cgstFloat, 2))
        try:
            if cgst in firstPage2:
                print(f" *** 'cgst' :'{cgst}' is matched with CHARGES Section first Page of pdf *** ")


        except:
            if cgst2 in firstPage2:
                print(f" *** 'cgst2' :'{cgst2}' is matched with CHARGES Section first Page of pdf *** ")
            else:
                print(f"Error :: 'cgst2' :'{cgst2}' is not matched with CHARGES Section first Page of pdf ")
            assert cgst2 in firstPage2, "is matched with CHARGES Section first Page of pdf"
        ...
        #Cheque / ECS / SI Return charges
        chequeBounceCharge = "₹500"
        if chequeBounceCharge in firstPage2:
            print(f" *** 'chequeBounceCharge' :'{chequeBounceCharge}' is inside CHARGES Section first Page of pdf *** ")
        else:
            print(f"Error :: 'chequeBounceCharge' :'{chequeBounceCharge}' is not inside CHARGES Section first Page of pdf ")

        assert chequeBounceCharge in firstPage2, "is inside CHARGES Section first Page of pdf"
        ...
        if latePaymentChargePerDayString in firstPage2:
            print(f" *** 'latePaymentChargePerDayString' :'{latePaymentChargePerDayString}' is matched and is inside CHARGES Section first Page of pdf *** ")
        else:
            print(f"Error :: 'latePaymentChargePerDayString' :'{latePaymentChargePerDayString}' is not matched and not inside CHARGES Section first Page of pdf ")

        assert latePaymentChargePerDayString in firstPage2, "is matched and within CHARGES Section first Page of pdf"
        ...
        try:
            if latePaymentChargePerAnnualString in firstPage2:
                print(f" *** 'latePaymentChargePerAnnualString' :'{latePaymentChargePerAnnualString}' is matched with CHARGES Section first Page of pdf *** ")
            else:
                print(f"Exception :: 'latePaymentChargePerAnnualString' :'{latePaymentChargePerAnnualString}' is not matched with CHARGES Section first Page of pdf ")

            assert latePaymentChargePerAnnualString in firstPage2, "is matched with CHARGES Section first Page of pdf"
        except:
            if latePaymentChargePerAnnualString2 in firstPage2:
                print(
                    f" *** 'latePaymentChargePerAnnualString2' :'{latePaymentChargePerAnnualString2}' is matched with CHARGES Section first Page of pdf *** ")
            else:
                print(
            ...
            assert latePaymentChargePerAnnualString2 in firstPage2, "is matched with CHARGES Section first Page of pdf"


        #Stamp Duty & Other Statutoty Charges :
        # legalCollection = "300"
        stampChargeString1 = "300"
        if stampChargeString1 in firstPage2:
            print(f" *** 'stampChargeString1' :'{stampChargeString1}' is matched with CHARGES Section first page of pdf *** ")
        else:
            print(f"Error :: 'stampChargeString1' :'{stampChargeString1}' is not matched with CHARGES Section first page of pdf ")

        assert stampChargeString1 in firstPage2, "is matched with CHARGES Section first page of pdf"
        ...
        if totalCost in thirdPage2:
            print(f" *** 'totalCost' :'{totalCost}' is matched with LETTER OF SANCTION TO THE BORROWER Section third page of pdf *** ")
        else:
            print(f"Error :: 'totalCost' :'{totalCost}' is not matched with LETTER OF SANCTION TO THE BORROWER Section third page of pdf ")

        assert totalCost in thirdPage2, "is matched with LETTER OF SANCTION TO THE BORROWER Section third page of pdf"
        ...
        loanDurationInDays = loanDurInDays + " days"
        totalPeriod = loanDurationInDays
        if totalPeriod in thirdPage2:
            print(f" *** 'totalPeriod' :'{totalPeriod}' is matched with LETTER OF SANCTION TO THE BORROWER Section third page of pdf *** ")
        else:
            print(f"Error :: 'totalPeriod' :'{totalPeriod}' is not matched with LETTER OF SANCTION TO THE BORROWER Section third page of pdf ")

        assert totalPeriod in thirdPage2, "is matched with LETTER OF SANCTION TO THE BORROWER Section third page of pdf"
        ...
        try:
            if commencingFrom in thirdPage2:
                print(f" *** 'commencingFrom' :'{commencingFrom}' is matched with LETTER OF SANCTION TO THE BORROWER Section third page of pdf *** ")
            else:
                print(f"Exception :: 'commencingFrom' :'{commencingFrom}' is not matched with LETTER OF SANCTION TO THE BORROWER Section third page of pdf ")

            assert commencingFrom in thirdPage2, "is matched with LETTER OF SANCTION TO THE BORROWER Section third page of pdf"
        ...
        stampCharge = 300
        stampChargeString2 = "₹300.00/-"
        if stampChargeString2 in thirdPage2:
            print(f" *** 'stampChargeString2' :'{stampChargeString2}' is matched with LETTER OF SANCTION TO THE BORROWER Section third page of pdf *** ")
        else:
            print(f"Error :: 'stampChargeString2' :'{stampChargeString2}' is not matched with LETTER OF SANCTION TO THE BORROWER Section third page of pdf ")

        assert stampChargeString2 in thirdPage2, "is matched with LETTER OF SANCTION TO THE BORROWER Section third page of pdf"


        # ONLINE CONVENIENCE CHARGES
        onlineConvCharge = 100
        onlineConvChargeString = "₹100"
        if onlineConvChargeString in thirdPage2:
            print(f" *** 'onlineConvChargeString' :'{onlineConvChargeString}' is inside LETTER OF SANCTION TO THE BORROWER Section third page of pdf *** ")
        else:
            print(f"Error :: 'onlineConvChargeString' :'{onlineConvChargeString}' is not inside LETTER OF SANCTION TO THE BORROWER Section third page of pdf ")

        assert onlineConvChargeString in thirdPage2, "is inside LETTER OF SANCTION TO THE BORROWER Section third page of pdf"
        ...
        try:
            try:
                ...
                if disbursement in thirdPage2:
                    print(f" *** 'disbursement' :'{disbursement}' is matched with LETTER OF SANCTION TO THE BORROWER Section third page of pdf *** ")
                else:
                    print(f"Exception :: 'disbursement' :'{disbursement}' is not matched with LETTER OF SANCTION TO THE BORROWER Section third page of pdf ")

                assert disbursement in thirdPage2, "is matched with LETTER OF SANCTION TO THE BORROWER Section third page of pdf"
        ...
        #Sanction Days
        sanctionDays = "10 days"
        if sanctionDays in fourthPage2:
            print(f" *** 'sanctionDays' :'{sanctionDays}' is matched with SECURITY DOCUMENTS fourth page of pdf *** ")
        else:
            print(f"Error :: 'sanctionDays' :'{sanctionDays}' is not matched with SECURITY DOCUMENTS fourth page of pdf ")

        assert sanctionDays in fourthPage2, "is matched with SECURITY DOCUMENTS fourth page of pdf"


        #Penal interest per day

        penalInterestPerDay = latePaymentChargePerDayString
        if penalInterestPerDay in fourthPage2:
            print(f" *** 'penalInterestPerDay' :'{penalInterestPerDay}' is matched with SECURITY DOCUMENTS fourth Page of pdf *** ")
        else:
            print(f"Error :: 'penalInterestPerDay' :'{penalInterestPerDay}' is not matched with SECURITY DOCUMENTS fourth Page of pdf ")

        assert penalInterestPerDay in fourthPage2, "penalInterestPerDay is matched with SECURITY DOCUMENTS fourth Page of pdf"

        # Penal interest per annum
        try:
            penalInterestPerAnnum = latePaymentChargePerAnnualString
            if penalInterestPerAnnum in fourthPage2:
                print(f" *** 'penalInterestPerAnnum' :'{penalInterestPerAnnum}' is matched with SECURITY DOCUMENTS fourth Page of pdf *** ")
            else:
                print(f"Exception :: 'penalInterestPerAnnum' :'{penalInterestPerAnnum}' is not matched with SECURITY DOCUMENTS fourth Page of pdf ")

            assert penalInterestPerAnnum in fourthPage2, "penalInterestPerAnnum is matched with SECURITY DOCUMENTS fourth Page of pdf"

        except:
            penalInterestPerAnnum2 = latePaymentChargePerAnnualString2
            if penalInterestPerAnnum2 in fourthPage2:
                print(
                    f" *** 'penalInterestPerAnnum2' :'{penalInterestPerAnnum2}' is matched with SECURITY DOCUMENTS fourth Page of pdf *** ")
            else:
                print(
            ...
            assert penalInterestPerAnnum2 in fourthPage2, "penalInterestPerAnnum2 is matched with SECURITY DOCUMENTS fourth Page of pdf"


        #Name of Borrower in security document
        try:
            if profileName in fourthPage2:
                print(f" *** 'profileName':'{profileName}' is matched with security document in fourth Page of pdf *** ")
            else:
                print(f"Exception :: 'profileName':'{profileName}' is not matched with security document in fourth Page of pdf ")

            assert profileName in fourthPage2, "profileName is matched with security document in fourth Page of pdf"

        except:
            if 'Name of Borrower' in firstPage2:
                index1 = firstPage2.index('Name of Borrower')
                index2 = firstPage2.index('NBFC NameChinmay Finlease')
                text = firstPage2[index1 + 16:index2]
                print(f"Name by pdf module :: {text}")
        ...
        if profileName in sixthPage2:
            print(f" *** 'profileName':'{profileName}' is matched with LOAN AGREEMENT sixth Page of pdf *** ")
        else:
            print(f"Exception :: 'profileName':'{profileName}' is not matched with LOAN AGREEMENT sixth Page of pdf ")

        assert profileName in sixthPage2, "profileName is matched with LOAN AGREEMENT sixth Page of pdf"
        ...
        try:
            if emailS in sixthPage2:
                print(f" *** 'email' :'{emailS}' is matched with LOAN AGREEMENT sixth Page of pdf *** ")
            else:
                print(f"Exception :: 'email' :'{emailS}' is not matched with LOAN AGREEMENT sixth Page of pdf ")

            assert emailS in sixthPage2, "email is matched with LOAN AGREEMENT sixth Page of pdf"

        except:
            eindex = emailS.index("View")
            email = emailS[:eindex - 1]

            if email in sixthPage2:
                print(f" *** 'email' :'{email}' is matched with LOAN AGREEMENT sixth Page of pdf *** ")
            else:
                print(f"Exception :: 'email' :'{email}' is not matched with LOAN AGREEMENT sixth Page of pdf ")

            assert email in sixthPage2, "email is matched with LOAN AGREEMENT sixth Page of pdf"


        # PAN number
        pan = driver.find_element(By.XPATH,"//div[contains(@class,'basic-details d-flex flex-row basic-info-card align-items-center justify-content-between mt-2')][2]//div[2]").text
        time.sleep(1)
        if pan in sixthPage2:
            print(f" *** 'pan' :'{pan}' is matched with LOAN AGREEMENT sixth Page of pdf *** ")
        else:
            print(f"Error :: 'pan' :'{pan}' is not matched with LOAN AGREEMENT sixth Page of pdf ")

        assert pan in sixthPage2, "pan is matched with LOAN AGREEMENT sixth Page of pdf"


        # loan amount
        lA = approvedAmount
        loanAmountstr = lA.replace("/-","")
        if loanAmountstr in sixthPage2:
            print(f" *** 'loanAmountstr' :'{loanAmountstr}' is matched with LOAN AGREEMENT sixth Page of pdf *** ")
        else:
            print(f"Error :: 'loanAmountstr' :'{loanAmountstr}' is not matched with LOAN AGREEMENT sixth Page of pdf ")

        assert loanAmountstr in sixthPage2, "loanAmountstr is matched with LOAN AGREEMENT sixth Page of pdf"

        # loan period
        if loanDurationInDays in sixthPage2:
            print(f" *** 'loanDurationInDays' :'{loanDurationInDays}' is matched with LOAN AGREEMENT sixth Page of pdf *** ")
        else:
            print(f"Error :: 'loanDurationInDays' :'{loanDurationInDays}' is not matched with LOAN AGREEMENT sixth Page of pdf ")

        assert loanDurationInDays in sixthPage2, "loanDurationInDays is matched with LOAN AGREEMENT sixth Page of pdf"


        # loan interest
        #per day
        try:
            if loanInterestPerDay in sixthPage2:
                print(f" *** 'loanInterestPerDay' :'{loanInterestPerDay}' is matched with LOAN AGREEMENT sixth Page of pdf *** ")
            else:
                print(f"Exception :: 'loanInterestPerDay' :'{loanInterestPerDay}' is not matched with LOAN AGREEMENT sixth Page of pdf ")

            assert loanInterestPerDay in sixthPage2, "loanInterestPerDay is matched with LOAN AGREEMENT sixth Page of pdf"
            ...
            try:
                ...
                assert loanInterestPerDay2 in sixthPage2, "loanInterestPerDay is matched with LOAN AGREEMENT sixth Page of pdf"

            except:

                if loanInterestPerDay3 in sixthPage2:
                    print(
                        f" *** 'loanInterestPerDay3' :'{loanInterestPerDay3}' is matched with LOAN AGREEMENT sixth Page of pdf *** ")
                else:
                    print(
                ...
                assert loanInterestPerDay3 in sixthPage2, "loanInterestPerDay3 is matched with LOAN AGREEMENT sixth Page of pdf"

        #per annum
        if loanIntPerAnnumStr in sixthPage2:
            print(f" *** 'loanIntPerAnnumStr' :'{loanIntPerAnnumStr}%' is matched with LOAN AGREEMENT sixth Page of pdf *** ")
        else:
            print(f"Error :: 'loanIntPerAnnumStr' :'{loanIntPerAnnumStr}' is not matched with LOAN AGREEMENT sixth Page of pdf ")

        assert loanIntPerAnnumStr in sixthPage2, "loanIntPerAnnumStr is matched with LOAN AGREEMENT sixth Page of pdf"


        # penalty interest
        #per day
        if latePaymentChargePerDayString in sixthPage2:
            print(f" *** 'latePaymentChargePerDayString' :'{latePaymentChargePerDayString}' is matched with LOAN AGREEMENT sixth Page of pdf *** ")
        else:
            print(f"Error :: 'latePaymentChargePerDayString' :'{latePaymentChargePerDayString}' is not matched with LOAN AGREEMENT sixth Page of pdf ")

        assert latePaymentChargePerDayString in sixthPage2, "latePaymentChargePerDayString is matched with LOAN AGREEMENT sixth Page of pdf"

        #per annum
        try:
            if latePaymentChargePerAnnualString in sixthPage2:
                print(f" *** 'latePaymentChargePerAnnualString' :'{latePaymentChargePerAnnualString}' is matched with LOAN AGREEMENT sixth Page of pdf *** ")
            else:
                print(f"Exception :: 'latePaymentChargePerAnnualString' :'{latePaymentChargePerAnnualString}' is not matched with LOAN AGREEMENT sixth Page of pdf ")

            assert latePaymentChargePerAnnualString in sixthPage2, "latePaymentChargePerAnnualString is matched with LOAN AGREEMENT sixth Page of pdf"
        except:
            if latePaymentChargePerAnnualString2 in sixthPage2:
                print(
                    f" *** 'latePaymentChargePerAnnualString2' :'{latePaymentChargePerAnnualString2}' is matched with LOAN AGREEMENT sixth Page of pdf *** ")
            else:
                print(
            ...
            assert latePaymentChargePerAnnualString2 in sixthPage2, "latePaymentChargePerAnnualString2 is matched with LOAN AGREEMENT sixth Page of pdf"

        '''Borrower Name in ninth page'''
        try:
            if profileName in ninthPage2:
                print(f" *** 'profileName':'{profileName}' is matched with witness in ninth Page of pdf *** ")
            else:
                print(f"Exception :: 'profileName':'{profileName}' is not matched with witness in ninth Page of pdf ")

            assert profileName in ninthPage2, "profileName is matched with witness in ninth Page of pdf"
        except:
            if 'Name of Borrower' in firstPage2:
                index1 = firstPage2.index('Name of Borrower')
                index2 = firstPage2.index('NBFC NameChinmay Finlease')
                text2 = firstPage2[index1 + 16:index2]
                print(f"Name by pdf module :: {text2}")
