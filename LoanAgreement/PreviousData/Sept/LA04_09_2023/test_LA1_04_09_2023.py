...
# JSON reader
file = open("input_04_09_2023.json")
info = json.load(file)
    ...
    def test_keyFactStatement(self, setup_teardown):
        ...
        try:
            ...
            if loanInterestPerDay2 in firstPage:
                ...
                print(
                    f"Error :: 'loanInterestPerDay2' :'{loanInterestPerDay2}' is not matched with LOAN DETAILS first Page of pdf ")
        ...
        try:
            ...
            if processChargeRs in firstPage:
                print(
                    f" *** 'processChargeRs' :'{processChargeRs}' is matched and with CHARGES Section first Page of pdf *** ")
            else:
                print(
                    f"Error :: 'processChargeRs' :'{processChargeRs}' is not matched with CHARGES Section first Page of pdf ")
        ...
        try:
            ...
            if latePaymentChargePerAnnualString2 in firstPage:
                ...
                print(
                    f"Exception :: 'latePaymentChargePerAnnualString2' :'{latePaymentChargePerAnnualString2}' is not matched with CHARGES Section first Page of pdf ")
        ...
        try:
            ...
            if loanInterestPerDay2 in sixthPage:
                ...
                print(
                    f"Error :: 'loanInterestPerDay2' :'{loanInterestPerDay2}' is not matched with LOAN AGREEMENT sixth Page of pdf ")

            assert loanInterestPerDay2 in sixthPage, "loanInterestPerDay2 is matched with LOAN AGREEMENT sixth Page of pdf"
