...
class TestDashRepo:
    ...
    def test_keyFactStatement(self, setup_teardown):
        ...
        try:
            ...
            if "COMMENCING FROM" in thirdPage:
                indexComm = thirdPage.index("COMMENCING FROM")
                indexT = thirdPage.index("TOTAL APPROVED AMOUNT")
                text = thirdPage[indexComm+15:indexT]
                print("By pdf::",text)
