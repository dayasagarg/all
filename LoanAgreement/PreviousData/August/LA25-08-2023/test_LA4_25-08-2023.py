...
fourthPage = reader.pages[4].extract_text()
sixthPage = reader.pages[6].extract_text()
ninthPage = reader.pages[9].extract_text()
...
class TestDashRepo:
    ...
    def test_keyFactStatement(self, setup_teardown):
        ...
        '''LOAN DETAILS'''
        # # Loan Amount
        apprAmount = driver.find_element(By.XPATH,"//tr[contains(@class,'mat-row cdk-row loan-history-row ng-star-inserted gray-bg')]//td[8]").text
        time.sleep(2)
