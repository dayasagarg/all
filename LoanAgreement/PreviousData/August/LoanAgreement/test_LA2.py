    ...
    def test_keyFactStatement(self, setup_teardown):
        ...
        try:
            if profileName in firstPage:
                ...
                print(f"Exception :: 'profileName':'{profileName}' is not matched with first Page of pdf ")
        ...
        try:
            if profileName in firstPage:
                ...
                print(f"Exception :: 'profileName':'{profileName}' is not matched with fourth Page of pdf ")

            assert profileName in firstPage, "profileName is matched with fourth Page of pdf"
        ...
        try:
            if profileName in firstPage:
                ...
                print(f"Exception :: 'profileName':'{profileName}' is not matched with sixth Page of pdf ")

            assert profileName in firstPage, "profileName is matched with sixth Page of pdf"
