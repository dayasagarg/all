...
class TestDashRepo:
    ...
    def test_keyFactStatement(self, setup_teardown):
        ...
        if gst in firstPage:
            print(f" *** 'gst' :'{gst}' is matched and within CHARGES Section first Page of pdf *** ")
        else:
            print(f"Error :: 'gst' :'{gst}' is not matched and not within CHARGES Section first Page of pdf ")

        assert gst in firstPage, "is matched and within CHARGES Section first Page of pdf"
        ...
        if legalCollection in firstPage:
            print(f" *** 'legalCollection' :'{legalCollection}' is matched with CHARGES Section first Page of pdf *** ")
        else:
            print(f"Error :: 'legalCollection' :'{legalCollection}' is not matched with CHARGES Section first Page of pdf ")

        assert legalCollection in firstPage, "is matched with CHARGES Section first Page of pdf"
        ...
        if stampChargeString in thirdPage:
            print(f" *** 'stampChargeString' :'{stampChargeString}' is matched with LETTER OF SANCTION TO THE BORROWER Section third page of pdf *** ")
        else:
            print(f"Error :: 'stampChargeString' :'{stampChargeString}' is not matched with LETTER OF SANCTION TO THE BORROWER Section third page of pdf ")

        assert stampChargeString in thirdPage, "is matched with LETTER OF SANCTION TO THE BORROWER Section third page of pdf"
        ...
        if email in sixthPage:
            ...
            print(f"Error :: 'email' :'{email}' is not matched with LOAN AGREEMENT sixth Page of pdf ")
