...
class TestDashRepo:
    ...
    def test_keyFactStatement(self, setup_teardown):
        time.sleep(1)
        driver.find_element(By.ID, "mainSearch").send_keys("L-483738")  # 
        time.sleep(1)
        ...
        # pdf reader
        reader = PyPDF2.PdfReader(r"C:\Users\lendi\OneDrive\Desktop\Users\1688312573612.pdf")  # pdf file location
