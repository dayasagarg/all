...
# JSON reader
file = open("input_28_08_2023.json")
info = json.load(file)
...
class TestDashRepo:
    ...
    def test_keyFactStatement(self, setup_teardown):
        ...
        '''LOAN DETAILS'''
        # # Loan Amount
        apprAmount = driver.find_element(By.XPATH,"//tr[contains(@class,'mat-row cdk-row loan-history-row ng-star-inserted gray-bg')]//td[8]//div").text
        time.sleep(2)
        ...
        loanInterestPerDay2 = loanIntPerDay.replace(" %", "00%")
        try:
        ...
        latePaymentChargePerAnnual = round(loanIntPerAnnum * 2,1)
        ...
        if loanInterestPerDay2 in sixthPage:
            print(f" *** 'loanInterestPerDay2' :'{loanInterestPerDay2}' is matched with LOAN AGREEMENT sixth Page of pdf *** ")
        else:
            print(f"Error :: 'loanInterestPerDay2' :'{loanInterestPerDay2}' is not matched with LOAN AGREEMENT sixth Page of pdf ")
