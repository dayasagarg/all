...
class TestDashRepo:
    ...
    def setup_teardown(self):
        ...
        driver.find_element(By.CSS_SELECTOR,
                            "body > app-root > app-auth > div > div:nth-child(2) > div > div > form > div.submit-btn.margin-top-bottom.d-flex.justify-content-center.ng-star-inserted > button").click()
        time.sleep(1)
        yield
        time.sleep(1)
        driver.close()
    ...
    def test_keyFactStatement(self, setup_teardown):
        ...
        try:
            if profileName in firstPage:
                print(
                    f" *** 'profileName':'{profileName}' is matched with KEY FACT STATEMENT in first Page of pdf *** ")
            else:
                print(
                    f"Exception :: 'profileName':'{profileName}' is not matched with KEY FACT STATEMENT in first Page of pdf ")
        ...
        # #loanId
        loanId = driver.find_element(By.XPATH,
                                     "//tr[contains(@class,'mat-row cdk-row loan-history-row bg-greywhite ng-star-inserted')]//td//a").text
        time.sleep(2)
        ...
        # Date of Signing
        try:
            loanAppDate = driver.find_element(By.XPATH,
                                              "(//div[@class='mobile-text fnt-size-12 ng-star-inserted'])[2]").text
            time.sleep(1)
            LoanApplicationDate = loanAppDate.replace('/', '-')

            if LoanApplicationDate in firstPage:
                print(
                    f" *** 'LoanApplicationDate' :'{LoanApplicationDate}' is matched with KEY FACT STATEMENT in first Page of pdf *** ")
            ...
            try:
                loanAppDate = driver.find_element(By.XPATH,
                                                  "(//div[@class='mobile-text fnt-size-12 ng-star-inserted'])[3]").text
                time.sleep(1)
                LoanApplicationDate = loanAppDate.replace('/', '-')
                ...
                if LoanApplicationDate in firstPage:
                    ...
                    print(
                        f"Exception :: 'LoanApplicationDate' :'{LoanApplicationDate}' is not matched with KEY FACT STATEMENT in first Page of pdf ")
        ...
        '''LOAN DETAILS'''
        # # Loan Amount
        apprAmount = driver.find_element(By.XPATH,
                                         "//tr[contains(@class,'mat-row cdk-row loan-history-row bg-greywhite ng-star-inserted')]//td[8]//div").text
        time.sleep(2)
        ...
        if approvedAmount in firstPage:
            ...
            print(
                f"Error :: 'approvedAmount' :'{approvedAmount}' is not matched with LOAN DETAILS in first Page of pdf ")

        assert approvedAmount in firstPage, "approvedAmount is matched with LOAN DETAILS in first Page of pdf"

        # Interest Rate (per Day)
        loanIntPerDay = driver.find_element(By.XPATH,
                                            "//td[contains(@class,'mat-cell cdk-cell mobile-text fnt-size-12 cdk-column-loanInterest mat-column-loanInterest ng-star-inserted')]").text
        time.sleep(1)
        ...
        try:
            if loanInterestPerDay in firstPage:
                print(
                    f" *** 'loanInterestPerDay' :'{loanInterestPerDay}' is matched with LOAN DETAILS in first Page of pdf *** ")
            else:
                print(
                    f"Exception :: 'loanInterestPerDay' :'{loanInterestPerDay}' is not matched with LOAN DETAILS in first Page of pdf ")
        ...
        if loanIntPerAnnumStr in firstPage:
            print(
                f" *** 'loanIntPerAnnumStr' :'{loanIntPerAnnumStr}%' is matched with LOAN DETAILS in first Page of pdf *** ")
        else:
            print(
                f"Error :: 'loanIntPerAnnumStr' :'{loanIntPerAnnumStr}%'  is not matched with LOAN DETAILS in first Page of pdf ")

        assert loanIntPerAnnumStr in firstPage, "loanIntPerAnnumStr is matched with LOAN DETAILS in first Page of pdf"

        # # Insurance premium amount
        inPremAmount = driver.find_element(By.XPATH,
                                           "//tr[contains(@class,'mat-row cdk-row loan-history-row bg-greywhite ng-star-inserted')]//td[9]//div").text
        time.sleep(1)
        insurancePremAmount = inPremAmount.replace(" ", "")
        if insurancePremAmount in firstPage:
            print(
                f" *** 'insurancePremAmount' :'{insurancePremAmount}' is matched with LOAN DETAILS in first Page of pdf *** ")
        else:
            print(
                f"Error :: 'insurancePremAmount' :'{insurancePremAmount}' is not matched with LOAN DETAILS in first Page of pdf ")

        assert insurancePremAmount in firstPage, "insurancePremAmount is matched with LOAN DETAILS in first Page of pdf"

        # # # Loan Tenure
        loanDurInDays = driver.find_element(By.XPATH,
                                            "//td[contains(@class,'mat-cell cdk-cell mobile-text fnt-size-12 cdk-column-loanDuration mat-column-loanDuration ng-star-inserted')]").text
        time.sleep(1)
        loanDurationInDays = loanDurInDays + " Days"
        if loanDurationInDays in firstPage:
            print(
                f" *** 'loanDurationInDays' :'{loanDurationInDays}' is matched with LOAN DETAILS in first Page of pdf *** ")
        else:
            print(
                f"Error :: 'loanDurationInDays' :'{loanDurationInDays}' is not matched with LOAN DETAILS in first Page of pdf ")

        assert loanDurationInDays in firstPage, "loanDurationInDays is matched with LOAN DETAILS in first Page of pdf"

        # # Loan Start Date
        loanDisbDate = driver.find_element(By.XPATH,
                                           "//td[contains(@class,'mat-cell cdk-cell cdk-column-loanStartDate mat-column-loanStartDate ng-star-inserted')]//div").text
        time.sleep(1)
        ...
        try:
            if loanDisbursedDate in firstPage:
                print(
                    f" *** 'loanDisbursedDate' :'{loanDisbursedDate}' is matched with LOAN DETAILS in first Page of pdf *** ")
            else:
                print(
                    f"Exception :: 'loanDisbursedDate' :'{loanDisbursedDate}' is not matched with LOAN DETAILS in first Page of pdf ")
        ...
        try:
            ...
            if loanEndDate2 in firstPage:
                ...
                print(
                    f"Error :: 'loanEndDate2' :'{loanEndDate2}' is not matched with LOAN DETAILS in first Page of pdf ")
        ...
        try:
            if processCharge in firstPage:
                print(
                    f" *** 'processCharge' :'{processCharge}' is matched with CHARGES Section in first Page of pdf *** ")
            else:
                print(
                    f"Exception :: 'processCharge' :'{processCharge}' is not matched with CHARGES Section in first Page of pdf ")
            ...
            if processChargeRs in firstPage:
                print(
                    f" *** 'processChargeRs' :'{processChargeRs}' is matched with CHARGES Section in first Page of pdf *** ")
            else:
                print(
                    f"Error :: 'processChargeRs' :'{processChargeRs}' is not matched with CHARGES Section in first Page of pdf ")
        ...
        if documentCharges in firstPage:
            print(
                f" *** 'documentCharges' :'{documentCharges}' is matched with CHARGES Section in first Page of pdf *** ")
        else:
            print(
                f"Error :: 'documentCharges' :'{documentCharges}' is not matched with CHARGES Section in first Page of pdf ")
        ...
        if onlineConvenienceFeesString in firstPage:
            print(
                f" *** 'onlineConvenienceFeesString' :'{onlineConvenienceFeesString}' is inside CHARGES Section of first Page of pdf *** ")
        else:
            print(
                f"Error :: 'onlineConvenienceFeesString' :'{onlineConvenienceFeesString}' is not inside CHARGES Section of first Page of pdf ")
        ...
        if chequeBounceCharge in firstPage:
            print(
                f" *** 'chequeBounceCharge' :'{chequeBounceCharge}' is inside CHARGES Section of first Page of pdf *** ")
        else:
            print(
                f"Error :: 'chequeBounceCharge' :'{chequeBounceCharge}' is not inside CHARGES Section of first Page of pdf ")
        ...
        if latePaymentChargePerDayString in firstPage:
            print(
                f" *** 'latePaymentChargePerDayString' :'{latePaymentChargePerDayString}' is matched and is inside CHARGES Section of first Page of pdf *** ")
        else:
            print(
                f"Error :: 'latePaymentChargePerDayString' :'{latePaymentChargePerDayString}' is not matched and not inside CHARGES Section of first Page of pdf ")
        ...
        try:
            if latePaymentChargePerAnnualString in firstPage:
                print(
                    f" *** 'latePaymentChargePerAnnualString' :'{latePaymentChargePerAnnualString}' is matched with CHARGES Section in first Page of pdf *** ")
            else:
                print(
                    f"Exception :: 'latePaymentChargePerAnnualString' :'{latePaymentChargePerAnnualString}' is not matched with CHARGES Section in first Page of pdf ")
        ...
        if stampChargeString1 in firstPage:
            print(
                f" *** 'stampChargeString1' :'{stampChargeString1}' is matched with CHARGES Section in first page of pdf *** ")
        else:
            print(
                f"Error :: 'stampChargeString1' :'{stampChargeString1}' is not matched with CHARGES Section in first page of pdf ")
        ...
        if totalCost in thirdPage:
            print(
                f" *** 'totalCost' :'{totalCost}' is matched with LETTER OF SANCTION TO THE BORROWER Section in third page of pdf *** ")
        else:
            print(
                f"Error :: 'totalCost' :'{totalCost}' is not matched with LETTER OF SANCTION TO THE BORROWER Section in third page of pdf ")
        ...
        if totalPeriod in thirdPage:
            print(
                f" *** 'totalPeriod' :'{totalPeriod}' is matched with LETTER OF SANCTION TO THE BORROWER Section in third page of pdf *** ")
        else:
            print(
                f"Error :: 'totalPeriod' :'{totalPeriod}' is not matched with LETTER OF SANCTION TO THE BORROWER Section in third page of pdf ")
        ...
        LoanDisbursementDate = driver.find_element(By.XPATH,
                                                   "(//div[@class='mobile-text fnt-size-12 ng-star-inserted'])[3]").text
        ...
        try:
            if commencingFrom in thirdPage:
                print(
                    f" *** 'commencingFrom' :'{commencingFrom}' is matched with LETTER OF SANCTION TO THE BORROWER Section in third page of pdf *** ")
            else:
                print(
                    f"Exception :: 'commencingFrom' :'{commencingFrom}' is not matched with LETTER OF SANCTION TO THE BORROWER Section in third page of pdf ")
        ...
        if stampChargeString2 in thirdPage:
            print(
                f" *** 'stampChargeString2' :'{stampChargeString2}' is matched with LETTER OF SANCTION TO THE BORROWER Section in third page of pdf *** ")
        else:
            print(
                f"Error :: 'stampChargeString2' :'{stampChargeString2}' is not matched with LETTER OF SANCTION TO THE BORROWER Section in third page of pdf ")
        ...
        if onlineConvChargeString in thirdPage:
            print(
                f" *** 'onlineConvChargeString' :'{onlineConvChargeString}' is inside LETTER OF SANCTION TO THE BORROWER Section in third page of pdf *** ")
        else:
            print(
                f"Error :: 'onlineConvChargeString' :'{onlineConvChargeString}' is not inside LETTER OF SANCTION TO THE BORROWER Section in third page of pdf ")
        ...
        try:
            disburse = loanAmountInt - (
                        processChargeInt + docChargFloat + stampCharge + onlineConvCharge + sgstFloat + cgstFloat + insCharg)
