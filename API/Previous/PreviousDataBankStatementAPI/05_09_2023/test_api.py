...
class TestPost:
    ...
    def test_postWBcS1(self):
        ...
        pdfFile = r"C:\Users\lendi\OneDrive\Desktop\API\bank statements\netBanking_name change (1).pdf"
    ...
    def test_postRBcS4(self):
        url = "http://144.24.112.239/bankingpro/statement/extractData"  # API URL
        pdfFile = r"C:\Users\lendi\OneDrive\Desktop\API\bank statements\s2.pdf"
        files = {"pdfFile": open(pdfFile, "rb")}
        headers = {
    ...
    def test_postRBcS5(self):
        url = "http://144.24.112.239/bankingpro/statement/extractData"  # API URL
        pdfFile = r"C:\Users\lendi\OneDrive\Desktop\API\bank statements\s1.pdf"
        files = {"pdfFile": open(pdfFile, "rb")}
        headers = {
