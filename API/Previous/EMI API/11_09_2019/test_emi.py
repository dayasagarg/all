...
class TestEMI:
    ...
    def test_getEMIAndgetRepaymentStatus(self):
        ...
        response = requests.get(
            "https://lendittfinserve.com/prod/admin/emi/getUpcomingEmi?start_date=2023-09-13T10%3A00%3A00.000Z&end_date=2023-09-13T10%3A00%3A00.000Z&emiStatus=1&isCountOnly=false&download=false",
            verify=False)
        ...
        response2 = requests.get(
            "https://lendittfinserve.com/prod/admin/emi/repaymentStatus?fromDate=2023-09-13T10%3A00%3A00.000Z&endDate=2023-09-13T10%3A00%3A00.000Z&type=TOTAL&page=1",
            verify=False)

        # print('status code of get RepaymentStatus::', response2.status_code)
