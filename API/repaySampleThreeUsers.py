    ...
    def test_getRepayment(self):
        ...
        for i in lIDs:
            ...
            if sum(totalUnpaidAmountE) == totalUnpaidAmountForm:
                print(f"Total unpaid amount in EMI data is as per formula{lIDs}")
            else:
                print(f"Error::Total unpaid amount in EMI data is not as per formula{lIDs}")
