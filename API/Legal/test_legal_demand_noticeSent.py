...
start = datetime.strptime("2023-11-10", "%Y-%m-%d") # 7 day ago from end
end = datetime.strptime("2023-11-17", "%Y-%m-%d") # 7 days ago date from current date(end_2)


start_2 = datetime.strptime("2023-11-09", "%Y-%m-%d") # 15 days ago from end date 2
end_2 = datetime.strptime("2023-11-24", "%Y-%m-%d")  # current date
