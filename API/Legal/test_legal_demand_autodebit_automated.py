...
previousDate_5 = currentDateF - timedelta(days=5)
previousDateStr_5 = datetime.strftime(previousDate_5,"%Y-%m-%d")
...
print("previousDateStr_5::",previousDateStr_5)
...
class TestLegal:
    ...
    def url(self):
        ...
        legalDemandLetter = requests.get("https://lendittfinserve.com/admin-prod/admin/legal/getAllLegalData",
        ...
        todayAutoDebitFailed = requests.get("https://lendittfinserve.com/admin-prod/admin/dashboard/todayAutoDebitData",
        ...
        todayAutoDebitFailed2 = requests.get("https://lendittfinserve.com/admin-prod/admin/dashboard/todayAutoDebitData",
