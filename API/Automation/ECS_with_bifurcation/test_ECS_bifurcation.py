...
class TestBounce:
    @pytest.fixture
    def bcURL(self):
        global autoDebitFailedAPI, emiRepaymentStatus, curr_str,curr_str_emi,pre_str_emi,pre_str_emi_2,pre_str_emi_3, disb_date_n, autoDebitFailedAPI_daily_emi
    ...
    def test_bounce_charg_autodebit_unpaid_current_date(self, bcURL):
        ...
        # print(autoDebitFailedAPI.json()["data"]["count"])
        # print(autoDebitFailedAPI_daily_emi.json()["data"]["count"])
    ...
    def test_bounce_charg_autodebit_unpaid_yestarday_date(self, bcURL):
        ...
        for e in autdebit_failed_loan_ids:
            ...
            for ed in emiAPI_data:
                if (ed["repaymentDate"] == pre_str_emi) or (ed["emiDate"] == pre_str_emi):
