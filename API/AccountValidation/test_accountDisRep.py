...
class TestAccount:
    ...
    def url(self):
        ...
        response1 = requests.get(
            "https://lendittfinserve.com/prod/admin/tally/getAllDisbursementDetails?startDate=2023-10-08T10:00:00.000Z&endDate=2023-10-08T10:00:00.000Z")  # Current date

        ##REPAYMENT SUMMARY
        response2 = requests.get(
            "https://lendittfinserve.com/prod/admin/tally/getAllRepaymentData?startDate=2023-10-08T10:00:00.000Z&endDate=2023-10-08T10:00:00.000Z")  # current date

        # AllDisbursedLoans
        response5 = requests.get(
            "https://lendittfinserve.com/prod/admin/dashboard/allDisbursedLoans?start_date=2023-10-08T10%3A00%3A00.000Z&end_date=2023-10-08T10%3A00%3A00.000Z&page=1&download=true")  # current date

        # AllRepaidLoans
        response4 = requests.get(
            "https://lendittfinserve.com/prod/admin/transaction/allRepaidLoans?start_date=2023-10-08T10:00:00.000Z&end_date=2023-10-08T10:00:00.000Z&page=1&pagesize=10&getTotal=true&download=true")  # current date
