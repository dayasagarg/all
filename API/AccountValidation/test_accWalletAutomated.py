...
class TestAccountWallet:
    ...
    def test_getTallyAccountWalletRazor1(self,url):
        ...
        global TotalOfWalletSettlementDebitFloat,Raz1RefundDebitFloat
        ...
        # AMOUNT RECIEVED IN
        amtReceivedInRaz1Name = walletSettlAPIResp.json()["data"]["titles"][0]["subtitles"][4]["name"]
        amtReceivedInRaz1Debit = walletSettlAPIResp.json()["data"]["titles"][0]["subtitles"][4]["debit"]
        amtReceivedInRaz1Credit = walletSettlAPIResp.json()["data"]["titles"][0]["subtitles"][4]["credit"]
    ...
    def test_getTallyAccountWalletRazor2(self,url):
        ...
        # # RAZORPAY REFUND
        # Raz2RefundName = walletSettlAPIResp.json()["data"]["titles"][1]["subtitles"][3]["name"]
        Raz2RefundDebit = walletSettlAPIResp.json()["data"]["titles"][1]["subtitles"][3]["debit"]
        # Raz2RefundCredit = walletSettlAPIResp.json()["data"]["titles"][1]["subtitles"][3]["credit"]
        #
        ...
        amtReceivedInRaz2Name = walletSettlAPIResp.json()["data"]["titles"][1]["subtitles"][4]["name"]
        amtReceivedInRaz2Debit = walletSettlAPIResp.json()["data"]["titles"][1]["subtitles"][4]["debit"]
        amtReceivedInRaz2Credit = walletSettlAPIResp.json()["data"]["titles"][1]["subtitles"][4]["credit"]
        #
    ...
    def test_getTallyAccountWalletTotal(self,url):
        ...
        #
        grandTotalOfWalletDebit = round(((walletRaz1GSTDebitFloat + walletRaz1ChargDebitFloat + amtReceivedInRaz1DebitFloat - Raz1RefundDebitFloat)+ (walletRaz2GSTDebitFloat + walletRaz2ChargDebitFloat + amtReceivedInRaz2DebitFloat - Raz2RefundDebitFloat) + (walletCashFreeGSTDebitFloat + walletCashFreeChargDebitFloat + amtReceivedInCashFreeDebitTotalFloat - walletCashFreeRefundDebitFloat)),2)
        print("grandTotalOfWalletDebit::", grandTotalOfWalletDebit)
