...
class TestRepaymentInterest:
    ...
    def test_getRepaymentIntAmt(self):
        ...
        responseAllLoanID = requests.get(
            "https://lendittfinserve.com/prod/admin/transaction/allRepaidLoans?start_date=2023-10-16T10:00:00.000Z&end_date=2023-10-16T10:00:00.000Z&page=1&pagesize=10&getTotal=true&download=true",
        ...
        print("Loan IDs::", lIDs)
        print('count of Loan IDs::', len(lIDs))
        ...
        response = requests.get(
            "https://lendittfinserve.com/prod/admin/loan/getEMIRepaymentDetails", params={"loanId": iNLId},
            verify=False)  # current date
